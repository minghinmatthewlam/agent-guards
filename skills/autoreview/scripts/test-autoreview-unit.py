...
class AutoReviewUnitTests(unittest.TestCase):
    ...
    def test_prompt_rejects_hypothetical_compatibility_work(self) -> None:
        ...
        self.assertIn("simplest clear implementation", prompt)
        self.assertIn("harder to understand, maintain, verify, or extend", prompt)
        self.assertIn("scope beyond the stated goal", prompt)
