---
name: autoreview
description: "Run OpenClaw structured code review as the default closeout check for local changes, branches, commits, and PR work. Uses Codex by default; Claude is optional for explicit second-model review."
---
...
Agent-guards global helper after sync:
